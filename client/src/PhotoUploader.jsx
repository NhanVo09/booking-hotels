    ...
    <>
      <div className="flex gap-2">
        <input
          ...
          placeholder="Đường dẫn hình ảnh .. jpg"
        />
        <button
          ...
          addedPhoto.map((link) => (
            <div key={link} className="h-32 flex relative">
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-1 text-white bg-opacity-50 rounded-xl bg-black p-2 px-5"
              >
                <svg
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 left-1 text-white bg-opacity-50 rounded-xl bg-black p-2 px-5"
              >
                {link !== addedPhoto[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
...
PhotoUploader.propTypes = {
  addedPhoto: PropTypes.array.isRequired,
